...
include_once __DIR__ . '/../../admin/config/db.php';
    ...
    if(isset($_POST['sbm'])){
        ...
        $sql = "INSERT INTO KhachHang(IDKhachHang, UserName, Pass, HoTen, Email, SDT, NgaySinh, DiaChi) 
        VALUES ('$IDKhachHang ','$UserName','$Pass','$HoTen', '$Email', '$SDT', '$NgaySinh', '$DiaChi')";
        ...
        <div class="card-body">
            <form method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" id="IDKhachHang" name="IDKhachHang" class="form-control" required>
                </div>
