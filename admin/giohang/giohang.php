                ...
                <?php
                    ...
                    while($row = mysqli_fetch_assoc($query)){?>
                        <tr>
                            ...
                            <td>
                            <img style="width :100px;" src="http://localhost/Web_TBYT/admin/image/<?php echo $row['HinhAnh']; ?>">
                            </td>
                            <td><a href="sua_giohang.php?id=<?php echo $row['IDGioHang']; ?>">Sửa</a></td>
                            <td><a href="xoa_giohang.php?id=<?php echo $row['IDGioHang']; ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa sản phẩm này?')">Xóa</a></td>
