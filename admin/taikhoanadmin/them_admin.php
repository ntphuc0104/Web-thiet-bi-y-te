...
include_once __DIR__ . '/../../admin/config/db.php';
    ...
    if(isset($_POST['sbm'])){
        ...
        $sql = "INSERT INTO `Admin`(IDAdmin, UserName, Pass, HoTen, Email, SDT, NgaySinh, DiaChi) 
        VALUES ('$IDAdmin ','$UserName','$Pass','$HoTen', '$Email', '$SDT', '$NgaySinh', '$DiaChi')";
        ...
        <div class="card-body">
            <form method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" id="IDAdmin" name="IDAdmin" class="form-control" required>
                </div>
