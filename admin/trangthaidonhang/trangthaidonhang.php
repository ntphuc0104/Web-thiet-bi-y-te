...
<div class="contrainer-fluid">
    <div class="card">
        ...
        <li class="dropdown">
                ...
                <li><a href="../admin/login/login.php">Thoát</a></li> 
                ...
                <?php
                    ...
                    while($row = mysqli_fetch_assoc($query)){?>
                        <tr>
                            ...
                            <td><a href="xoa_trangthaidonhang.php?id=<?php echo $row['IDTrangThaiDonHang']; ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa này?')">Xóa</a></td>
                        </tr>
                     <?php }?>
